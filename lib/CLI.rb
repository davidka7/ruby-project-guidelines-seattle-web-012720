...
def greet
  ...
  def run
   ...
   # wob = puts "You feeling excited, want to sponsor a race and change its location, sure!!"
    ...
    #dub = puts "Want to bet on a race, amazing, please enter the name of the race, rider your betting on as well as the amount your betting, thank you..race:,rider:,amount:"
